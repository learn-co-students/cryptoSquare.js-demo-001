...
Review the `crypto.js` file inside the `lib` directory, and then the `crypto.spec.js` file inside the `spec` directory. Review each of the tests, and then start implementing your solutions to make each test pass in `crypto.js`.
